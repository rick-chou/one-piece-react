...
import { codeFontFamily } from '../../_config/theme';
import Codepen from './components/codepen';
import Codesandbox from './components/codesandbox';
import SequenceChart from './components/sequence-chart';
import { codeBlockStyle, codeBtnStyle, codeFilename, useCodeStyle } from './style';
            ...
            return (
              <div className="not-prose" css={codeStyle}>
                <figure css={codeBlockStyle}>
                  ...
                  <pre {...props} className="!bg-[#002b36]" css={css({ code: { fontFamily: codeFontFamily } })}></pre>
                </figure>
              </div>
            );
          },
