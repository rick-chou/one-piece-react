import{u as r,j as n,a as e,F as c}from"./index-Dt7Lsx6p.js";import"./antd-DGkp10QV.js";import"./lodash-BVSlK2Pl.js";import"./prettier-DJQX7j1f.js";import"./chance-DnaHbaGl.js";const p={title:"JavaScript - design-patterns-strategy"};function a(l){const s=Object.assign({blockquote:"blockquote",p:"p",h2:"h2",code:"code",pre:"pre",span:"span",h3:"h3"},r(),l.components);return e(c,{children:[e(s.blockquote,{children:[`
...
`,n(s.p,{children:"· 要使用策略模式，必须了解所有的策略，必须了解各个策略之间的不同点，因为各种算法之间相互独立，对于复杂的算法处理相同的逻辑无法实现共享。"})]})}function o(l={}){const{wrapper:s}=Object.assign({},r(),l.components);return s?n(s,Object.assign({},l,{children:n(a,l)})):a(l)}export{o as default,p as frontmatter};
