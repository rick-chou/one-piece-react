...
`,n(s.p,{children:"reducer 中是否可以处理异步操作呢 ？？？"})]})}function j(a={}){const{wrapper:s}=Object.assign({},r(),a.components);return s?n(s,Object.assign({},a,{children:n(c,a)})):c(a)}function i(a,s){throw new Error("Expected "+(s?"component":"object")+" `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{j as default,m as frontmatter};
