import{u as c,j as n,a,F as i}from"./index-Dt7Lsx6p.js";import"./antd-DGkp10QV.js";import"./lodash-BVSlK2Pl.js";import"./prettier-DJQX7j1f.js";import"./chance-DnaHbaGl.js";const m={title:"JavaScript - decorate"};function e(l){const s=Object.assign({h2:"h2",pre:"pre",code:"code",span:"span",p:"p",ul:"ul",li:"li"},c(),l.components);return a(i,{children:[n(s.h2,{children:"配置装饰器环境"}),`
...
`]})}),`
`,n(s.p,{children:"借助装饰器 我们就有能力改变类内部的方法和变量"})]})}function o(l={}){const{wrapper:s}=Object.assign({},c(),l.components);return s?n(s,Object.assign({},l,{children:n(e,l)})):e(l)}export{o as default,m as frontmatter};
