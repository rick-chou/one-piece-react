import{u as t,j as n,a as c,F as i}from"./index-Bpq67avY.js";import"./antd-Sqqp5mxm.js";import"./lodash-aGR4VZ5D.js";import"./prettier-y3XyMyrW.js";import"./chance-DnaHbaGl.js";const a={title:"JavaScript - prototype"};function r(o){const e=Object.assign({p:"p",blockquote:"blockquote",code:"code",strong:"strong",ul:"ul",li:"li"},t(),o.components);return c(i,{children:[n(e.p,{children:"在 ES2019 中 对于 prototype 的定义为"}),`
...
`]}),`
`]}),`
`,c(e.p,{children:["所以 如果我们用",n(e.code,{children:"Object.prototype"}),"去操作了 Object 的原型对象 那么所有的对象都会受到影响 因为 Object 是对象的顶级父类 所有的对象都继承自它们的顶级父类 Object"]})]})}function u(o={}){const{wrapper:e}=Object.assign({},t(),o.components);return e?n(e,Object.assign({},o,{children:n(r,o)})):r(o)}export{u as default,a as frontmatter};
