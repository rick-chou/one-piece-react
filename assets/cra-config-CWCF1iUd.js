import{u as e,j as n,a,F as h}from"./index-Dt7Lsx6p.js";import"./antd-DGkp10QV.js";import"./lodash-BVSlK2Pl.js";import"./prettier-DJQX7j1f.js";import"./chance-DnaHbaGl.js";const u={title:"React Quick Start - CRA Config"};function c(l){const s=Object.assign({h2:"h2",p:"p",code:"code",h3:"h3",ul:"ul",li:"li",pre:"pre",span:"span"},e(),l.components);return a(h,{children:[n(s.h2,{children:"配置 cra"}),`
...
`]})})]})}function m(l={}){const{wrapper:s}=Object.assign({},e(),l.components);return s?n(s,Object.assign({},l,{children:n(c,l)})):c(l)}export{m as default,u as frontmatter};
