import{u as c,j as s,a,F as i}from"./index-3486abdc.js";import"./antd-3342c5aa.js";import"./lodash-6114c6d4.js";import"./chance-d5bce0ad.js";const p={title:"Angular Quick Start - Project"};function e(l){const n=Object.assign({p:"p",blockquote:"blockquote",a:"a",code:"code",h3:"h3",pre:"pre",span:"span",ol:"ol",li:"li",img:"img"},c(),l.components);return a(i,{children:[s(n.p,{children:"由于最近工作的转变 技术栈也由 React 向 Angular 进行了切换"}),`
...
`,s(n.p,{children:s(n.img,{src:"https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a120c32f14a846239d618fcf32dfeead~tplv-k3u1fbpfcp-watermark.image?",alt:"Screen Shot 2022-08-12 at 11.23.04.png"})})]})}function o(l={}){const{wrapper:n}=Object.assign({},c(),l.components);return n?s(n,Object.assign({},l,{children:s(e,l)})):e(l)}export{o as default,p as frontmatter};
