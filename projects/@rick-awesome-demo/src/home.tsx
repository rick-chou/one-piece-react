  ...
  <div className="header">
    ...
    <div className="user-settings">
      <img
        ...
        alt=""
      />
      <div className="user-name">Rick.Zhou</div>
...
const Content = () => (
  <div className="main-container">
    <div className="main-header anim" css={animationDelay(0)}>
      Discover
    </div>
    <div className="main-blogs">
      <div className="main-blog anim" css={animationDelay(0.1)}>
        ...
        <div className="main-blog__author">
          ...
          <div className="author-detail">
            <div className="author-name">Rick.Zhou Hope</div>
      ...
      <div className="main-blog anim" css={animationDelay(0.2)}>
    ...
    <div className="small-header anim" css={animationDelay(0.3)}>
      Most Watched
    </div>
    <div className="videos">
      <div className="video anim" css={animationDelay(0.4)}>
      ...
      <div className="video anim" css={animationDelay(0.5)}>
      ...
      <div className="video anim" css={animationDelay(0.6)}>
      ...
      <div className="video anim" css={animationDelay(0.7)}>
      ...
      <div className="video-stream">
        ...
        <div className="video-detail">
          <div className="video-content">
            <div className="video-p-wrapper anim" css={animationDelay(0.1)}>
            ...
            <div className="video-p-title anim" css={animationDelay(0.2)}>
              Basic how to ride your Skateboard
            </div>
            <div className="video-p-subtitle anim" css={animationDelay(0.3)}>
            ...
            <div className="video-p-subtitle anim" css={animationDelay(0.4)}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
      ...
      <div className="chat-stream">
        <div className="chat">
          ...
          <div className="message-container">
            <div className="message anim" css={animationDelay(0.1)}>
              <div className="author-img__wrapper video-author video-p">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="message anim" css={animationDelay(0.2)}>
              <div className="author-img__wrapper video-author video-p">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="message anim" css={animationDelay(0.3)}>
              <div className="author-img__wrapper video-author video-p">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="message anim" css={animationDelay(0.4)}>
              <div className="author-img__wrapper video-author video-p">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
              ...
              <div className="msg-wrapper">
                <div className="msg__name video-p-name"> Rick.Zhou Hope</div>
                <div className="msg__content video-p-sub">
                  {' '}
            ...
            <div className="message anim" css={animationDelay(0.5)}>
              <div className="author-img__wrapper video-author video-p">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div className="message anim" css={animationDelay(0.6)}>
              <div className="author-img__wrapper video-author video-p">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
          ...
          <div className="chat-footer anim" css={animationDelay(0.1)}>
            <input type="text" placeholder="Write your message" />
          </div>
        </div>
        <div className="chat-vid__container">
          <div className="chat-vid__title anim" css={animationDelay(0.3)}>
            Related Videos
          </div>
          <div className="chat-vid anim" css={animationDelay(0.4)}>
          ...
          <div className="chat-vid anim" css={animationDelay(0.5)}>
            <div className="chat-vid__wrapper">
              <img
                className="chat-vid__img"
          ...
          <div className="chat-vid__button anim" css={animationDelay(0.6)}>
