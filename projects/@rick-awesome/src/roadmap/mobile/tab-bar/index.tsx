/**
 * @link https://codepen.io/abxlfazl/pen/OJbEbxL
 */
...
const TabBar = () => {
  useEffect(() => {
    ...
    let activeButton =
      document.querySelector<HTMLElement>('.menu__item.active')!;
  ...
  return (
    <menu className="menu">
      <button className="menu__item active">
        ...
        <strong className="menu__text active">home</strong>
      </button>
      <button className="menu__item">
        ...
        <strong className="menu__text">strategy</strong>
      </button>
      <button className="menu__item">
        <div className="menu__icon">
          <svg
            ...
            <g id="period-cir">
              <path
                fill="currentColor"
                strokeWidth={0}
                d="M96.5,141.7c0,3.9-3.1,7-7,7s-7-3.1-7-7s3.1-7,7-7C93.4,134.6,96.5,137.8,96.5,141.7z"
              />
              <path
                fill="currentColor"
                strokeWidth={0}
            ...
            <g id="period-anm">
              ...
              <path
                strokeLinecap="round"
                d="M149.4,153.3H30.6 M75.5,90.7l-23.1,21.2c-1.6,1.4-2.4,3.4-2.4,5.6v35.9h78.1V113"
              />
              <g id="period-line">
        ...
        <strong className="menu__text">period</strong>
      </button>
      <button className="menu__item">
        <div className="menu__icon">
          <svg
            ...
            <path
              strokeLinecap="round"
              d="M94,139c-4.8,1.3-8.8,1.7-11.4,1.8c0,0-18.3,1.1-36.9-11.6c-1.9-1.3-4.7-3.2-7.8-6.2c-1.7-1.6-2.9-2.9-3.4-3.6
            ...
            <path
              id="security-cir"
              strokeLinecap="round"
              d="M158.3,120.7c0,18.3-14.8,33.1-33.1,33.1s-33-14.8-33-33.1s14.8-33.1,33.1-33.1S158.3,102.4,158.3,120.7z"
            />
            <g id="security-strok">
              <path
                strokeLinecap="round"
        ...
        <strong className="menu__text">security</strong>
      </button>
      <button className="menu__item">
        <div className="menu__icon">
          <svg
            ...
            <g id="settings-anm">
              <path
                strokeLinejoin="round"
                d="M144.7,73.8l-6.2-1c-0.6-1.5-1.2-3-1.9-4.5l3.6-5.1c3.2-4.4,2.7-10.5-1.2-14.3l-7.4-7.4
        ...
        <strong className="menu__text">settings</strong>
      </button>
    </menu>
  );
};
