      ...
      <div className="wrapper">
        ...
        <div className="dog">
          <div className="body-wrapper">
            <div className="body img-bg" />
          </div>
          <div className="head-wrapper">
            <div className="head img-bg" />
          </div>
          <div className="leg-wrapper">
            <div className="leg one img-bg" />
          </div>
          <div className="leg-wrapper">
            <div className="leg two img-bg" />
          </div>
          <div className="leg-wrapper">
            <div className="leg three img-bg" />
          </div>
          <div className="leg-wrapper">
            <div className="leg four img-bg" />
          </div>
          <div className="tail-wrapper">
            <div className="tail img-bg" />
          </div>
        </div>
      </div>
