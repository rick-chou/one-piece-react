...
import {
  ...
  nodeTypes,
  presetNode,
} from '@/modules/project/flowcharts/config';
...
import { useModalOpen } from '@/modules/project/flowcharts/hooks/useModalOpen';
import { useNavigate } from '@/modules/project/flowcharts/hooks/useNavigate';
import type {
  FlowChartType,
  NodeDataType,
} from '@/modules/project/flowcharts/interface';
import { Action, NodeType } from '@/modules/project/flowcharts/interface';
import {
