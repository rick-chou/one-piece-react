...
import { edgeTypes, nodeTypes, presetNode } from '@rick-flow/config';
import { useAction } from '@rick-flow/hooks/useAction';
import { useFlowState } from '@rick-flow/hooks/useFlowState';
import { useFlowchart } from '@rick-flow/hooks/useFlowchart';
import { useMock } from '@rick-flow/hooks/useMock';
import { useModalOpen } from '@rick-flow/hooks/useModalOpen';
import { useNavigate } from '@rick-flow/hooks/useNavigate';
import type { FlowChartType, NodeDataType } from '@rick-flow/interface';
import { Action, NodeType } from '@rick-flow/interface';
import {
  FlowContainerClassname,
  FlowNodeClassname,
  FlowNodeDragoverClassname,
  flowContainer,
} from '@rick-flow/styles';
import {
  isTree,
  transformData,
  transformDataFromChart,
} from '@rick-flow/utils';
...
const FlowEdit = () => {
  ...
  const onNodeChange = () => {
    if (editNode) {
      ...
      setNodes(transformData(_nodes) as any);
