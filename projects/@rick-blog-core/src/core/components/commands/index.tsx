import { Hotkey } from '@/core/config/shortcut';
import { useModalOpen } from '@/core/hooks/useModalOpen';
import { RouteProps } from '@/core/interface';
import { BlogRoutes } from '@/core/router/blog';
import { sidebar } from '@/core/router/meta-data';
import { OpenTypeConfig } from '@/core/store/slice/modalOpenSlice';
